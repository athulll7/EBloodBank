        ...
        children: [
          Column(
            children: [
              ...
              Image( 
                 image: AssetImage('assets/logo ebloodbank.png'),height: 180,
               ),
              ...
              ListTile(
                title: Text('- Donor Login',style: TextStyle(fontSize: 28,color:Colors.white,fontWeight: FontWeight.w400),),
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Donor_login_screen()));
                },
              ),
              Divider(
                color: Colors.white,
              ...
              ListTile(
                title: Text('- Blood Bank Login',style: TextStyle(fontSize: 28,color:Colors.white,fontWeight: FontWeight.w400 ),),
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Bloodbank_login_screen()));
                },
              ),
              Divider(
                color: Colors.white,
              ...
              ListTile(
                title: Text('- Requests',style: TextStyle(fontSize: 28,color:Colors.white,fontWeight: FontWeight.w400 ),),
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Requests_screen()));
                },
              ),
              Divider(
                color: Colors.white,
              ...
              ListTile(
                title: Text('- Raise Request',style: TextStyle(fontSize: 28,color:Colors.white,fontWeight: FontWeight.w400 ),),
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Raise_request_screen()));
                },
              ),
              Divider(
                color: Colors.white,
      ...
      Column(
        children: [
           ...
           const Image(
                 ...
                 image: AssetImage('assets/blood_drop.png'),height: 250,
               ),
              const SizedBox(
            height: 20,
           ),
           ...
           Container(width: MediaQuery.of(context).size.width*.89,
          ...
          SizedBox(
           ...
           shape: const CircleBorder(),
             ...
             IconButton(onPressed: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Search_result_screen()));
             }, icon: Icon(Icons.search),iconSize: 80,splashColor: Colors.grey,)
             ],),
           ),
